...
import 'package:flutter_app/player_wave_painter.dart';
import 'package:flutter_app/player_wave_style.dart';
...
class _AudioFileWaveformsState extends State<AudioFileWaveforms>
  ...
  Future _initialiseVariables() async {
    _waveData = await _readAudioFile(widget.filePath);
    showSeekLine = false;
    margin = widget.margin;
    padding = widget.padding;
    decoration = widget.decoration;
  ...
  Future _readAudioFile(String path) async {
    File file = File(path);
